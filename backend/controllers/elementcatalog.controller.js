...
async function CreateElementCatalog(req, res) {
    try {
...
async function UpdateElementCatalog(req, res) {
    try {
...
async function DeleteElementCatalog(req, res) {
    try {
        let elementcatalog = { element_catalog_id: req.body.element_catalog_id, element_name: req.body.element_name }
...
async function elementcatalogbyname(req, res) {
    try {
